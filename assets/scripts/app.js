const listWord = [
    ...
    ["Sword", "Link from Zelda have on the hand."], ["Girl", "Not boy but ?"],
    ["Boy", "Not girl but ?"], [
        "Female", "Other name as girl."], ["Male", "Other name as boy."],
    ["Smartphone", "Something you've always on you."]];

const [word, tips] = listWord[Math.trunc(Math.random() * (listWord.length - 1))];
...
const creatKeyword = () => {
    const keyword = document.querySelector('#keybord');
